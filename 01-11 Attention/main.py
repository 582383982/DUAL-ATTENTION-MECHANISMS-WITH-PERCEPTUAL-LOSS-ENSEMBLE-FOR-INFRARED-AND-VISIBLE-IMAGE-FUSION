...
SSIM_WEIGHTS = [10, 100, 1000]
SSIM_WEIGHTS_A=[10, 100]

#-------------------------------------------------------------------------------------------------
MODEL_SAVE_PATHS = [
	'/data/ljy/1-Project-Go/01-11-upsampling+attention/models/densefuse_model_bs2_epoch4_all_weight_1e0.ckpt',
    '/data/ljy/1-Project-Go/01-11-upsampling+attention/models/densefuse_model_bs2_epoch4_all_weight_1e1.ckpt',
    '/data/ljy/1-Project-Go/01-11-upsampling+attention/models/densefuse_model_bs2_epoch4_all_weight_1e2.ckpt',
    '/data/ljy/1-Project-Go/01-11-upsampling+attention/models/densefuse_model_bs2_epoch4_all_weight_1e3.ckpt',
]
MODEL_SAVE_PATHS_A = [
	'/data/ljy/1-Project-Go/01-11-upsampling+attention/models_a/densefuse_model_bs2_epoch4_all_weight_1e0.ckpt',
	'/data/ljy/1-Project-Go/01-11-upsampling+attention/models_a/densefuse_model_bs2_epoch4_all_weight_1e1.ckpt',
	'/data/ljy/1-Project-Go/01-11-upsampling+attention/models_a/densefuse_model_bs2_epoch4_all_weight_1e2.ckpt',
]
...
#---------------------------------------------------------------------------------------------------------
	...
	#================================================================================================
		...
		if IS_VIDEO:
			...
			path ='/data/ljy/Generate/Nato_camp_sequence/'
			for i in range(32):
				#if i < 10 :
				#	continue
				index = i + 1
				infrared = path + 'Ir' + str(index) + '.bmp'
				visible = path + 'Vis' + str(index) + '.bmp'
